...
out.report <- linreg_path(data[[1]],data[[2]],data[[3]],data[[4]],data[[5]],lambda_graph,lambda_sparse,data[[6]],data[[7]],reporting=TRUE,max_num_iter=3e3)
...
legend(1000,3,c("Augmented ADMM", "Standard ADMM", "fGFL"), col = c("blue","orange","red"), lty=c(1,1,1),bty="n",cex=.8)
