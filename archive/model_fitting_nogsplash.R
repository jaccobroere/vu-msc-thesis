...
path_Dtilde_SDF_inv <- file.path(sim_id_dir, "Dtilde_SDF_inv.mtx")
path_Dtilde_SDF <- file.path(sim_id_dir, "Dtilde_SDF.mtx")
...
Dtilde_SDF_inv <- readMM(path_Dtilde_SDF_inv)
Dtilde_SDF <- readMM(path_Dtilde_SDF)
...
model_sdfsplash <- fit_sdfsplash.cv(y, bandwidths, reg_gr, Dtilde_SDF_inv, alpha = 0.5, nlambdas = 20, nfolds = 3)
toc()
